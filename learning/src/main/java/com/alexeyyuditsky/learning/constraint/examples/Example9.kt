...
fun Example9() {
    ConstraintLayout(modifier = Modifier.fillMaxSize()) {
        ...
        val (startBound, endBound, rectFillToConstraint, rectMatchParent, rectPercentage, rectWrapContent, rectPrefWrapContent, rectPreferredValue, prefAspectRatio) = createRefs()
